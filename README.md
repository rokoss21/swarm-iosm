...
In Claude Code, type `/swarm` — you should see the skill activate.
...
| Command | Description |
|---------|-------------|
| `/swarm setup` | Initialize project context |
...
| `/swarm integrate <track-id>` | Merge work, run IOSM quality gates |
...
## Real-World Application: AstroVisor

The [AstroVisor.io](https://astrovisor.io) professional astrology platform was built using IOSM principles:

| Phase | Problem | IOSM Application |
|-------|---------|------------------|
| **Improve** | 14 overlapping astrological systems | Unified domain model, structure map |
| **Optimize** | 40ms response target | Redis caching, parallel processing, CDN |
| **Shrink** | 95+ endpoints complexity | MCP server for natural language access |
| **Modularize** | Adding new traditions | Self-contained modules with contracts |

> See [IOSM README](https://github.com/rokoss21/IOSM#real-world-example-building-the-astrovisor-api-platform) for detailed case study.
