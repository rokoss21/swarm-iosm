...
- [x] `user-invocable: true` (allows /swarm commands)
...
### 2. Create Track
```
/swarm new-track "Add Hello World endpoint to API"
```
- [ ] Questions asked
...
### 6. Integrate
```
/swarm integrate YYYY-MM-DD-NNN
```
...
3. Try explicit invocation: `/swarm setup`
...
- [ ] Activation test passes (run `/swarm setup`)
